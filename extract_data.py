...
column_names = [
    ...
    "Direccion_DenomProvincia", "Direccion_CodigoPostal", "dia", "mes", "ano","Interviniente_Nombre2", "Propietario", "cccPropietario", "FechaMasVeintiunDias", "Expediente", "Deuda",
...
def process_line(line):
    ...
    print("Datos contacto:", datos_contacto)
    ...
    documento = [
        datos_basicos[0].strip(),  # Bar_Code
    ...
    if sum(bool(campo) for campo in documento) >= len(documento) // 2:
        ...
        print(f"Línea descartada por insuficientes datos válidos: {line}")
        return None
        ...
        with open(input_filename, 'r', encoding='utf-8') as infile, \
            ...
            for line in infile:
                if line.strip():  # Ignorar líneas vacías
                    processed_parts = process_line(line)
                    if processed_parts:
